...
public class NewCustomer extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            if(!t4.getText().matches("[a-zA-Z]+"))
                JOptionPane.showMessageDialog(this,"Invalid input for state");
           else if(!t6.getText().matches("^[a-z0-9]+[\\._]?[a-z0-9]+[@]\\w+[.]\\w{2,3}$"))
            {
                JOptionPane.showMessageDialog(this,"Invalid Email");
            }
            else if(!t7.getText().matches("[0-9]{10}"))
            {
                JOptionPane.showMessageDialog(this,"Invalid Input / Enter 10 digits");
            }
